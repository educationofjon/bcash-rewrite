...
exports.getMaxBlockSigopsCount = function getMaxBlockSigopsCount(blocksize) {
  const megabyte = 1 + ((blocksize - 1) / exports.ONE_MEGABYTE | 0);
  return megabyte * exports.MAX_BLOCK_SIGOPS;
};
