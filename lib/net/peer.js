...
class Peer extends EventEmitter {
  ...
  /**
   * Test whether the BCASH service bit is set.
   * @returns {Boolean}
   */

  hasBCASH() {
    return (this.services & services.CASH) !== 0;
  }
...
class PeerOptions {
  ...
  constructor(options) {
    ...
    this.hasBCASH = PeerOptions.hasBCASH;
  ...
  fromOptions(options) {
    ...
    if (options.hasBCASH != null) {
      assert(typeof options.hasBCASH === 'function');
      this.hasBCASH = options.hasBCASH;
    }
