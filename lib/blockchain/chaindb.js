...
class ChainDB {
  ...
  async verifyFlags(state) {
    ...
    if (!options.UAHF && flags.UAHF)
      throw new Error('Cannot retroactively disable Bitcoin Cash Sighashing.');
...
class ChainFlags {
  ...
  fromOptions(options) {
    ...
    if (options.UAHF != null) {
      assert(typeof options.UAHF === 'boolean');
      this.UAHF = options.UAHF;
    }
